...
func testVectors() []testVector {
	return []testVector{
		...
		{
			kap:        decodeString("fee1deadfee1deadfee1deadfee1deadfee1deadfee1deadfee1deadfee1dead"),
			ka:         decodeString("872f435bb8b89d0e3ad62aa2e511074ee195e1c39ef6a88001418be656e3c376"),
			kbp:        decodeString("b105f00db105f00db105f00db105f00db105f00db105f00db105f00db105f00d"),
			kb:         decodeString("d1b6941bba120bcd131f335da15778d9c68dadd398ae61cf8e7d94484ee65647"),
...
func parsedResponses(t *testing.T) []URLResponse {
